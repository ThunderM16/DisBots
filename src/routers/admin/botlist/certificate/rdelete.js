...
console.log("[DisList>me]: Admin/Botlist/report Decline router loaded.");
...
app.get("/admin/delete/:botID/report", global.checkAuth, async (req, res) => {
    ...
    client.channels.cache.get(channels.botlog).send(`❎ The report applied on <@${botdata.ownerID}>'s bot has been deleted.`)
